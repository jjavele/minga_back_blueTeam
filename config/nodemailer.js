...
let transporter = nodemailer.createTransport({
    ...
    let infoEmail = await transporter.sendMail({
        ...
        <tr>
        <td align="center">
        <img height="auto" src="https://i.postimg.cc/5yFcvrDd/minga.png" style="display:block;border:0px;text-decoration:none;border-style:none;color:#ffffff;border-width:0" width="99" class="CToWUd" data-bit="iit">
        </td>
        </tr>
        <tr>
        <td height="32" style="height:32px;min-height:32px;line-height:32px;font-size:1px">
        ...
        <tr>
        <td align="center" style="padding-top:16px">
        <p style="font-family:Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:normal;color:##4338CA;max-width:380px;text-align:center">
        ...
        <tbody><tr>
        <td align="center" height="43" style="border-collapse:collapse;background-color:#4338CA;border-radius:9px;white-space:nowrap">
        <a href='http://localhost:5173/mail-verification/${user.verify_code}' style="display:inline-block;width:100%;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold;line-height:19px;color:#fff;text-align:center;text-decoration:none;background-color:##4338CA;border-radius:14px;border-top:12px solid ##4338CA;border-bottom:12px solid #4338CA;text-transform:uppercase" target="_blank" data-saferedirecturl="    ">
